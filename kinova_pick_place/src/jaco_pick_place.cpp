...
void PickPlace::addCollisionObjects()
{
  ...
  collision_objects[0].primitives[0].dimensions[0] = 0.18;//dim[1];//0.18;  //height 
  collision_objects[0].primitives[0].dimensions[1] = 0.03;//dim[0];//0.03;  //radius
  ...
  collision_objects[0].primitive_poses[0].position.x = 0.2;//pose[0];
  collision_objects[0].primitive_poses[0].position.y = 0.2;//pose[1];
  collision_objects[0].primitive_poses[0].position.z = 0.1;//pose[2];
